...
class ApiService {
	...
	async createRecipe(data) {
		console.log('🔍 DEBUG: API Service createRecipe called with data:', JSON.stringify(data, null, 2));
		...
		console.log('🔍 DEBUG: API Service createRecipe response:', JSON.stringify(result, null, 2));
		return result;
	}
